...
export const updateReservation = async(id, data) => {
    // Menerima data berupa object { status: 'confirmed' } atau data perbaikan lain
    const payload = typeof data === 'string' ? { status: data } : data;
    const res = await api.put(`/admin/reservations/${id}`, payload);
    return res.data;
};

// Alias untuk updateReservation agar kompatibel dengan ReservationDetailPage
